...
const Footer = () => {
  return (
    // Changed bg-foreground to a lighter color (bg-slate-50) so black text is visible
    <footer className="bg-slate-50 py-16"> 
      <div className="container mx-auto px-4 md:px-8">
        <div className="grid md:grid-cols-4 gap-10 mb-12">
          ...
          <div className="md:col-span-1">
            <div className="flex items-center gap-2 mb-4">
              <div className="w-8 h-8 rounded-full bg-primary flex items-center justify-center">
                ...
                <span className="text-black font-display font-bold text-sm">U</span>
              </div>
          ...
          {/* Programs */}
          <div>
            <h4 className="font-semibold text-sm mb-4 text-black">
              Programs
            </h4>
        ...
        {/* Changed border to black/10 */}
        <div className="border-t pt-6 border-black/10">
