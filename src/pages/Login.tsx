...
const Login = () => {
  ...
  const redirectByRole = async (userId: string) => {
    ...
    if (roles.includes("employer")) return navigate("/employer");
    if (roles.includes("mentor")) return navigate("/mentor-dashboard");
    if (roles.includes("counselor")) return navigate("/dashboard");
    navigate("/dashboard");
  };
